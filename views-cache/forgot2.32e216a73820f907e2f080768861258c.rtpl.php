...
<body style="background-color: #ffffff">
  ...
  <div style="text-align: center">
    <table class="head-wrap w320 full-width-gmail-android" style="background-color: #f9f8f8" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td background="https://www.filepicker.io/api/file/UOesoVZTFObSHCgUDygC" style="background-color: #ffffff" width="100%" height="8" valign="top">
          <!--[if gte mso 9]>
    ...
    <table class="footer-wrap w320 full-width-gmail-android" style="background-color: #e5e5e5">
      <tr>
        <td></td>
        <td class="container">
